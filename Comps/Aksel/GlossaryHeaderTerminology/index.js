...
const GlossaryHeaderTree = () => <div className="glossaryHeader_container">
    ...
    <div className="glossaryHeader_bot">
        <div className="glossary_button_container">
            <p className="terminology_glossary_button_text terminology_glossary_button_text_1">Trees</p>
            <p className="terminology_glossary_button_text terminology_glossary_button_text_2">Flowering Plant</p>
            <p className="terminology_glossary_button_text terminology_glossary_button_text_3">Terminology</p>
        </div>
    </div>
